...
with tab1:
    ...
    st.session_state["frequency_cap"] = st.slider("Frequency Cap (max. frequentie per gebruiker) 🛈", help="Maximaal aantal keer dat een gebruiker de advertentie te zien krijgt binnen de campagneperiode.", 1, 20, st.session_state["frequency_cap"])

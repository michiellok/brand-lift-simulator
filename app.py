...
with tab1:
    ...
    st.session_state["creative_effectiveness"] = st.slider("Creative Effectiveness Score (0-1) 🛈", 0.1, 1.0, st.session_state["creative_effectiveness"], help="De verwachte effectiviteit van de creatieve boodschap. Dit beïnvloedt de uiteindelijke brand lift."), 0.1, 1.0, st.session_state["creative_effectiveness"])
